...
<div class="theme-layout">
	...
	<div class="responsive-header">
		<div class="mh-head first Sticky">
			...
			<span class="mh-text">
				<a href="newsfeed.html" title=""><img src="{{ asset('Frontend/images/Capture-removebg-preview.png') }}" height="10" alt=""></a>
			</span>
	...
	<div class="topbar stick">
		<div class="logo" style="height: 10;">
			<a title="" href="newsfeed.html"><img src="{{ asset('Frontend/images/Capture-removebg-preview.png') }}"  alt=""></a>
		</div>
				...
				<div class="row merged">
					<div class="col-lg-2 col-sm-3">
						<div class="user-avatar">
							<figure>
								<img src="{{ asset('Frontend/images/resources/user-avatar.jpg') }}" alt="">
								<form class="edit-phto">
									<i class="fa fa-camera-retro"></i>
									<label class="fileContainer">
										Edit Display Photo
							...
							<div class="col-lg-3">
								<aside class="sidebar static">
									...
									<div class="widget stick-widget">
										...
										<ul class="followers">
											<li>
												<figure><img src="{{ asset('Frontend/images/resources/friend-avatar2.jpg') }}" alt=""></figure>
											...
											<li>
												<figure><img src="{{ asset('Frontend/images/resources/friend-avatar4.jpg') }}" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="{{ asset('Frontend/images/resources/friend-avatar6.jpg') }}" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="{{ asset('Frontend/images/resources/friend-avatar8.jpg') }}" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="{{ asset('Frontend/images/resources/friend-avatar3.jpg') }}" alt=""></figure>
												<div class="friend-meta">
											...
											<div class="friend-info">
												...
												<div class="post-meta">
													<div class="linked-image align-left">
														<a href="#" title=""><img src="{{ asset('Frontend/images/resources/page1.jpg') }}" alt=""></a>
													</div>
													<div class="detail">
								...
								<aside class="sidebar static">
									<div class="widget">
										<div class="banner medium-opacity bluesh">
											...
											<div class="baner-top">
												<span><img src="{{ asset('Frontend/images/book-icon.png') }}" alt=""></span>
									...
									<div class="widget friend-list stick-widget">
										...
										<ul id="people-list" class="friendz-list">
											...
											<li>
												<figure>
													<img src="{{ asset('Frontend/images/resources/friend-avatar3.jpg') }}" alt="">
											...
											<li>
												<figure>
													<img src="{{ asset('Frontend/images/resources/friend-avatar4.jpg') }}" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="widget">
						<div class="foot-logo">
							<div class="logo">
								<a href="index-2.html" title=""><img src="{{ asset('Frontend/images/Capture-removebg-preview.png') }}"  alt=""></a>
							</div>	
							<p>
