...
<div class="theme-layout">
	...
	@include('User.Home.phoneHeader')	

	{{-- phone end --}}
	@include('User.Home.webHeader')	
	{{--header end  --}}
	@yield('content')
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="widget">
						<div class="foot-logo">
							<div class="logo">
								<a href="index-2.html" title=""><img src="{{ asset('Frontend/images/Final-removebg-preview 1 (4).png') }}"  alt=""></a>
							</div>	
							<p>
	...
	<div class="bottombar">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<span class="copyright">© FITBOUNCER 2022. All rights reserved.</span>
