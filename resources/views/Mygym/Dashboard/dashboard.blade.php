...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-4 col-sm-6">
        <div class="icon-card mb-30">
            ...
            <a href="{{ route("my-gym-events.index") }}">
            <div class="content">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img src="{{ asset('Gym/assets/images/products/product-mini-1.jpg') }}"
                                                alt="" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img src="{{ asset('Gym/assets/images/products/product-mini-2.jpg') }}"
                                                alt="" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img src="{{ asset('Gym/assets/images/products/product-mini-3.jpg') }}"
                                                alt="" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product">
                                        <div class="image">
                                            <img src="{{ asset('Gym/assets/images/products/product-mini-4.jpg') }}"
                                                alt="" />
                                        </div>
