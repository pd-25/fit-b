...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset("Gym/assets/images/favicon.svg") }}"
      type="image/x-icon"
    />
    ...
    <link rel="stylesheet" href="{{ asset("Gym/assets/css/fullcalendar.css") }}" />
    <link rel="stylesheet" href="{{ asset("Gym/assets/css/fullcalendar.css") }}" />
              ...
              <div class="header-right">
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  >
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset("Gym/assets/images/lead/lead-6.png") }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset("Gym/assets/images/lead/lead-1.png") }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="header-message-box ml-15 d-none d-md-flex">
                  ...
                  >
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset("Gym/assets/images/lead/lead-5.png") }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Jacob Jones</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset("Gym/assets/images/lead/lead-3.png") }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>John Doe</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset("Gym/assets/images/lead/lead-2.png") }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Anee Lee</h6>
                ...
                <div class="profile-box ml-15">
                  ...
                  >
                    <div class="profile-info">
                      <div class="info">
                        ...
                        <div class="image">
                          <img
                            src="{{ asset("Gym/assets/images/profile/profile-image.png") }}"
                            alt=""
                          />
                  ...
                  >
                    ...
                    <li>
                      <a href="{{ route("mygym.logout")}}"> <i class="lni lni-exit"></i> Sign Out </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="icon-card mb-30">
                    ...
                    <div class="content">
                        <h6 class="mb-10">My gym members</h6>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="icon-card mb-30">
                    ...
                    <a href="{{ route("gym-my-events.index") }}">
                    <div class="content">
